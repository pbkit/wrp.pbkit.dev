...
import 'https://esm.sh/prismjs@1.27.0/components/prism-bash.js?no-check';
import 'https://esm.sh/prismjs@1.27.0/components/prism-yaml.js?no-check';
import 'https://esm.sh/prismjs@1.27.0/components/prism-protobuf.js?no-check';
